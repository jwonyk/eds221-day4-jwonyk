# add up the number of birds and dogs
...
# write updated version of the animal age function with error messages
...
# all the data frames in the functions are called df --> argument df
df_means <- function(df) {
  ...
  for(i in 1:ncol(df)) {
    ...
    print(paste("The mean of value of", column_name, "is", col_mean))
...
# coming time steps and population size into a data frame
